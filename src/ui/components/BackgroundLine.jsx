...
const BackgroundLine = ({verticalCount = 3, horizontalCount = 3}) => {

    return (
        <div className={"BackgroundLine"} style={{ "--horizontalCount": horizontalCount + 1, "--verticalCount": verticalCount + 1 }}>
